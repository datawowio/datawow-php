...
class Verification extends Connector
{
    ...
    {
        return parent::create_data(get_class(), base_url("docs").get_path("docs", "verification"), $token, json_encode($params));
    }
    ...
    public static function gets($token, $params = array())
    {
        ...
        return parent::retrieve_list(get_class(), base_url("docs").get_path("docs", "verification"), $token, json_encode($params));
    }

    public static function find_id($token, $id)
    {
        return parent::retrieve_once(get_class(), base_url("docs").get_path("docs", "verification"), $token, $id);
    }
}
